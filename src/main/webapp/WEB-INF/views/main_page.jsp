...
<jsp:include page="/resources/head.jsp" />
	...
	<div class="Container container">
        ...
        <div class="col-lg-6">
          <h4><a href="<c:url value="/main/event/create" />">Create an Event</a></h4>
          <p>Donec id elit non mi porta gravida at eget metus. Maecenas faucibus mollis interdum.</p>

          <h4><a href="<c:url value="" />">Subscribe to an Event</a></h4>
          <p>Maecenas sed diam eget risus varius blandit sit amet non magna.</p>

          <h4><a href="<c:url value="" />">My tickets</a></h4>
          <p>Maecenas sed diam eget risus varius blandit sit amet non magna.</p>
        </div>

        <div class="col-lg-6">
          <h4><a href="<c:url value="" />">Manage created Events</a></h4>
          <p>Donec id elit non mi porta gravida at eget metus. Maecenas faucibus mollis interdum.</p>

          <h4><a href="<c:url value="/main/listForParticipant" />">Manage Subscribed</a></h4>
